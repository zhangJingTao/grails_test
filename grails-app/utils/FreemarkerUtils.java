...
public class FreemarkerUtils {
     ...
     */
    public static void initFreeMarker(Configuration configuration) {
        if (!(isInit)) {
     ...
     * @param templateFileName ftl模版路径(已默认为WEB-INF/freemarke,文件名相对此路径)
     * @param outFileName      生成文件名称(可带路径)
     * @param isAbsPath        是否绝对路径
     */
    public static File crateFile(Map<String, Object> data, String templateFileName, String outFileName, boolean isAbsPath) {
        if (!isInit) {
