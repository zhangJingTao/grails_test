        ...
        <div class="row">
            <div class="menu-holder">
                ...
                <div class="col-md-7 col-sm-8">
                    <nav class="main-menu hidden-xs">
                        <ul>
                            ...
                            <li><a href="http://onlysleep.net/zhihu">Collect</a></li>
                ...
                <div class="col-md-2 col-sm-2 col-xs-12">
                    <ul class="social-top">
                        <li><a href="http://weibo.com/zhangjingtaorss" target="_blank"><i class="fa fa-weibo"></i><span class="hidden-xs">Weibo</span></a></li>
                        <li><a href="http://www.github.com/zhangjingtao" target="_blank"><i class="fa fa-github"></i><span class="hidden-xs">Github</span></a></li>
%{--
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <ul class="doneList">
                    ...
                    <li><i class="fa fa-check"></i><a href="/weibo/features" target="_blank">微博收藏</a>.@SleepCollect收藏微博</li>
                    ...
                    <li><i class="fa fa-check"></i>Ghost Blog，基于<a href="http://ghost.org/" target="_blank">Ghost</a>开源博客</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="product-content col-md-7 col-xs-12">
                    <h3>Plan</h3>
                    <span></span>
                    <p>这个服务器一直在随意发挥，更新频率与我的工作忙碌程度成负相关。限于本人能力有限，也不会有厉害的东西出现，代码与<a href="http://www.github.com/zhangjingtao/sleep-site">这里</a>同步。虽然没有明了的愿景，但希望这里不会太差，随着时间的积累，五年、十年或者更久，总是可以让我回头看看，这些年写过的代码，好玩的东西，就够了</p>
                </div>
            </div> <!-- .col-md-6 -->
            <div class="col-md-6">
                <div class="product-content col-md-7 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12 contact-info">
                <ul>
                    ...
                    <li><i class="fa fa-envelope"></i> <a href="mailto:zhangjingtaosleep@163.com">zhangjingtaosleep@163.com</a></li>
                </ul>
            </div>
        </div> <!-- .row -->
    </div> <!-- .container -->
