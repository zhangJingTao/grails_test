...
<head>
    ...
    <title>后台管理 --powered by BootStrap&&sb-admin</title>
    <!-- Bootstrap Core CSS -->
    ...
    <ul class="dropdown-menu dropdown-messages">
        <li>
            <a href="#">
                ...
                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend/admin.</div>
            </a>
        </li>
        <li class="divider"></li>
        <li>
    ...
    <div class="chat-panel panel panel-default">
        ...
        <div class="panel-footer">
            <div class="input-group">
                <input id="btn-input" type="text" class="form-control input-sm" placeholder="Type your message here/admin." />
                <span class="input-group-btn">
